...
public class SocialNetworkTest {
    ...
    public void createMember() {
        ...
        assertThat(member.getGender(), equalTo(Gender.MALE));
    ...
    public void testApplyToSelectedMembers() {
        SocialNetwork socialNetwork = new SocialNetwork(Arrays.asList(
                new Member("John Doe", Arrays.asList("Java", "OOP"), Gender.MALE),
                new Member("Jane Doe", Arrays.asList(".NET", "OOP", "db"), Gender.FEMALE),
                new Member("James Doe", Arrays.asList("Python", "Java", "OOP"), Gender.MALE),
                new Member("Janet Doe", Arrays.asList("JavaScript", "scripting", "db"), Gender.FEMALE),
                new Member("Jenifer Doe", Arrays.asList("C", "C++", "ASM"), Gender.FEMALE)
        ));

        socialNetwork.applyToSelectedMembers(
                m -> m.getGender() == Gender.FEMALE && m.getSkills().contains("db"),
