...
public class BankAccountsTest {
    ...
    public void testListBankAccountsByAccountNumber() {
        ...
        List<BankAccount> sorted = accounts.bankAccountListByNumber();
    ...
    public void testListBankAccountsByBalance() {
        ...
        List<BankAccount> sorted = accounts.bankAccountListByBalance();
    ...
    public void testListBankAccountsByBalanceDesc() {
        ...
        List<BankAccount> sorted = accounts.bankAccountListByBalanceDesc();
    ...
    public void testListBankAccountsByNameThanAccountNumber() {
        ...
        List<BankAccount> sorted = accounts.bankAccountListByNameAndNumber();
